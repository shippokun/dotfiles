...
noremap <SNR>38_Visual y:call twitvim#post_twitter(@", 0)
...
set runtimepath+=~/.cache/vim/pack/minpac/start/vim-projectionist
set runtimepath+=~/.cache/vim/pack/minpac/start/vim-prettier
set runtimepath+=~/.cache/vim/pack/minpac/start/vim-multiple-cursors
set runtimepath+=~/.cache/vim/pack/minpac/start/vim-markdown
set runtimepath+=~/.cache/vim/pack/minpac/start/vim-gitgutter
set runtimepath+=~/.cache/vim/pack/minpac/start/vim-easy-align
set runtimepath+=~/.cache/vim/pack/minpac/start/vim-devicons
set runtimepath+=~/.cache/vim/pack/minpac/start/vim-css-color
set runtimepath+=~/.cache/vim/pack/minpac/start/vim-better-whitespace
set runtimepath+=~/.cache/vim/pack/minpac/start/vim-autoclose
set runtimepath+=~/.cache/vim/pack/minpac/start/vim-airline-themes
set runtimepath+=~/.cache/vim/pack/minpac/start/vim-airline
set runtimepath+=~/.cache/vim/pack/minpac/start/twitvim
set runtimepath+=~/.cache/vim/pack/minpac/start/tcomment_vim
set runtimepath+=~/.cache/vim/pack/minpac/start/rust.vim
set runtimepath+=~/.cache/vim/pack/minpac/start/indentLine
set runtimepath+=~/.cache/vim/pack/minpac/start/emmet-vim
...
set runtimepath+=~/.cache/vim/pack/minpac/start/indentLine/after
...
set wildignore=*.o,*.out,*.obj,.git,*.rbc,*.rbo,*.class,.svn,*.gem,*.gif,*.jpg,*.png,*.log,*/vendor/gems/*,*/vendor/cache/*,*/.bundle/*,*/.sass-cache/*,.DS_Store
set wildmenu
set nowritebackup
